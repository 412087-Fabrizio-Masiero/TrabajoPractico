...
namespace ComercioInteriorV1.Data.Implementations
{
    public class ArticulosRepository : IArticulosRepository
    {
        ...
        public ArticulosRepository(DataHelper dataHelper)
        {
        ...
        public bool Delete(int id)
        {
            ...
            return _dataHelper.ExecuteSpDml("sp_Eliminar_Articulo", param);
        }

        public List<Articulos> GetAll()
        {
            var dt = _dataHelper.ExecuteSpQuery("sp_ObtenerArticulos");
        ...
        public Articulos? GetById(int id)
        {
            ...
            var dt = _dataHelper.ExecuteSpQuery("sp_ObtenerArticulos_Por_Id", list);
        ...
        public bool Save(Articulos articulo)
        {
            ...
            return _dataHelper.ExecuteSpDml("sp_Guardar_Articulo", param);
        ...
        public bool Update(Articulos articulo)
        {
            ...
            return _dataHelper.ExecuteSpDml("sp_Modificar_Articulo", param);
